...
public class TS_SHttpConfigHandlerFile {
    ...
    private TS_SHttpConfigHandlerFile(String slash_path_slash, TGS_Func_OutBool_In1<TS_SHttpHandlerRequest> allow, Path root, boolean filterUrlsWithHiddenChars) {
        this.slash_path_slash = TGS_FuncEffectivelyFinal.ofStr()
    ...
    final public TGS_Func_OutBool_In1<TS_SHttpHandlerRequest> allow;
    final public Path root;
    final public boolean filterUrlsWithHiddenChars;

    public static TS_SHttpConfigHandlerFile of(String slash_path_slash, TGS_Func_OutBool_In1<TS_SHttpHandlerRequest> allow, Path root, boolean filterUrlsWithHiddenChars) {
