...
public class TS_SHttpHandlerString extends TS_SHttpHandlerAbstract {
    ...
    private TS_SHttpHandlerString(String slash_path, TGS_CompilerType1<String, HttpExchange> handle) {
        super(slash_path, handle);
    }

    public static TS_SHttpHandlerString of(String slash_path, TGS_CompilerType1<String, HttpExchange> handle) {
